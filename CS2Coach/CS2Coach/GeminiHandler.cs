...
namespace CS2Coach
{
    public class GeminiHandler
    {
        ...
        public static List<Google.GenAI.Types.Content> FormatContent(string gsiReport, List<Mat> images)
        {
            ...
            parts.Add(new Part { Text = "You are a helpful assistant for Counter Strike 2 players. You are given a game report and screenshots. In quick bullet points only give tips on the round and gameplay.\n" });
